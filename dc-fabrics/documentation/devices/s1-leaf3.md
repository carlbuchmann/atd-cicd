...
| --------- | --------------- | ------------ | --------- |
| LEAF2-DC1 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| Ethernet4 | s1-Host2_E1 | *trunk | *100,110,200,210 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet4 | routed | - | 172.30.11.9/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet4 | routed | - | 172.30.11.11/31 | default | 9214 | False | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 172.30.11.11/31
!
interface Ethernet4
   description s1-Host2_E1
   no shutdown
...
| 172.30.11.8 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.11.10 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.0.255.5:10100 | 10100:10100 | - | - | learned |
| 110 | 192.0.255.5:10110 | 10110:10110 | - | - | learned |
| 200 | 192.0.255.5:10200 | 10200:10200 | - | - | learned |
| 210 | 192.0.255.5:10210 | 10210:10210 | - | - | learned |
| 300 | 192.0.255.5:10300 | 10300:10300 | - | - | learned |
...
router bgp 65102
   ...
   neighbor 172.30.11.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.11.8 remote-as 65001
   neighbor 172.30.11.8 description s1-spine1_Ethernet4
   neighbor 172.30.11.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.11.10 remote-as 65001
   neighbor 172.30.11.10 description s1-spine2_Ethernet4
   ...
   !
   vlan 200
      rd 192.0.255.5:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 210
      rd 192.0.255.5:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 300
      rd 192.0.255.5:10300
