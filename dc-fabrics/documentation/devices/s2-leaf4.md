...
| --------- | --------------- | ------------ | --------- |
| LEAF2-DC2 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf3_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet4 | s2-Host2_E2 | *trunk | *100,110,200,210 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf3_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-leaf3_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.6/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.2.255.6:10100 | 10100:10100 | - | - | learned |
| 110 | 192.2.255.6:10110 | 10110:10110 | - | - | learned |
| 200 | 192.2.255.6:10200 | 10200:10200 | - | - | learned |
| 210 | 192.2.255.6:10210 | 10210:10210 | - | - | learned |
| 300 | 192.2.255.6:10300 | 10300:10300 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.2.255.6:10 | connected |
...
router bgp 65202
   ...
   !
   vlan 100
      rd 192.2.255.6:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 110
      rd 192.2.255.6:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 200
      rd 192.2.255.6:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 210
      rd 192.2.255.6:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 300
      rd 192.2.255.6:10300
