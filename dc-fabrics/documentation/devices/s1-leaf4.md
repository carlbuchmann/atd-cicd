...
| --------- | --------------- | ------------ | --------- |
| LEAF2-DC1 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet5 | routed | - | 172.30.11.13/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet5 | routed | - | 172.30.11.15/31 | default | 9214 | False | - | - |
...
| 172.30.11.12 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.11.14 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.0.255.6:10100 | 10100:10100 | - | - | learned |
| 110 | 192.0.255.6:10110 | 10110:10110 | - | - | learned |
| 200 | 192.0.255.6:10200 | 10200:10200 | - | - | learned |
| 210 | 192.0.255.6:10210 | 10210:10210 | - | - | learned |
| 300 | 192.0.255.6:10300 | 10300:10300 | - | - | learned |
...
router bgp 65102
   ...
   neighbor 172.30.11.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.11.12 remote-as 65001
   neighbor 172.30.11.12 description s1-spine1_Ethernet5
   neighbor 172.30.11.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.11.14 remote-as 65001
   neighbor 172.30.11.14 description s1-spine2_Ethernet5
   ...
   !
   vlan 200
      rd 192.0.255.6:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 210
      rd 192.0.255.6:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 300
      rd 192.0.255.6:10300
