...
| --------- | --------------- | ------------ | --------- |
| BORDER-DC2 | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-brdr1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | MLAG_PEER_s2-brdr1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet8 | routed | - | 172.30.12.21/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet8 | routed | - | 172.30.12.23/31 | default | 9214 | False | - | - |
| Ethernet4 | s2 Border Leaf 1 | routed | - | 172.16.200.5/31 | default | 9214 | False | - | - |
| Ethernet5 | s2 Border Leaf 1 | routed | - | 172.16.200.3/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-brdr1_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| 172.16.200.4 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.12.20 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.12.22 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.2.255.8:10100 | 10100:10100 | - | - | learned |
| 110 | 192.2.255.8:10110 | 10110:10110 | - | - | learned |
| 200 | 192.2.255.8:10200 | 10200:10200 | - | - | learned |
| 210 | 192.2.255.8:10210 | 10210:10210 | - | - | learned |
| 300 | 192.2.255.8:10300 | 10300:10300 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.2.255.8:10 | connected |
...
router bgp 65203
   ...
   neighbor 172.16.200.2 description s1-brdr1
   neighbor 172.16.200.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.200.4 remote-as 65103
   neighbor 172.16.200.4 description s1-brdr2
   neighbor 172.30.12.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.20 remote-as 65002
   neighbor 172.30.12.20 description s2-spine1_Ethernet8
   neighbor 172.30.12.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.22 remote-as 65002
   neighbor 172.30.12.22 description s2-spine2_Ethernet8
   ...
   !
   vlan 100
      rd 192.2.255.8:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 110
      rd 192.2.255.8:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 200
      rd 192.2.255.8:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 210
      rd 192.2.255.8:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 300
      rd 192.2.255.8:10300
