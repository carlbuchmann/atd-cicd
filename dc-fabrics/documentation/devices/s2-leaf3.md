...
| --------- | --------------- | ------------ | --------- |
| LEAF2-DC2 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf4_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet4 | s2-Host2_E1 | *trunk | *100,110,200,210 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf4_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | 172.30.12.9/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | 172.30.12.11/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-leaf4_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.2.254.5/32 |
...
| 172.30.12.8 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.12.10 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.2.255.5:10100 | 10100:10100 | - | - | learned |
| 110 | 192.2.255.5:10110 | 10110:10110 | - | - | learned |
| 200 | 192.2.255.5:10200 | 10200:10200 | - | - | learned |
| 210 | 192.2.255.5:10210 | 10210:10210 | - | - | learned |
| 300 | 192.2.255.5:10300 | 10300:10300 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.2.255.5:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.255.251.5 description s2-leaf4
   neighbor 172.30.12.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.8 remote-as 65002
   neighbor 172.30.12.8 description s2-spine1_Ethernet4
   neighbor 172.30.12.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.10 remote-as 65002
   neighbor 172.30.12.10 description s2-spine2_Ethernet4
   ...
   !
   vlan 100
      rd 192.2.255.5:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 110
      rd 192.2.255.5:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 200
      rd 192.2.255.5:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 210
      rd 192.2.255.5:10210
      route-target both 10210:10210
      redistribute learned
   !
   vlan 300
      rd 192.2.255.5:10300
