...
| --------- | --------------- | ------------ | --------- |
| LEAF1-DC2 | Vlan4094 | 10.255.252.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet4 | s2-Host1_E2 | *trunk | *100,110,200 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 172.30.12.5/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 172.30.12.7/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-leaf1_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.4/32 |
...
| 172.30.12.4 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.12.6 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.2.255.4:10 | connected |
...
router bgp 65201
   ...
   neighbor 10.255.251.0 description s2-leaf1
   neighbor 172.30.12.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.4 remote-as 65002
   neighbor 172.30.12.4 description s2-spine1_Ethernet3
   neighbor 172.30.12.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.12.6 remote-as 65002
   neighbor 172.30.12.6 description s2-spine2_Ethernet3
