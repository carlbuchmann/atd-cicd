...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | - | default | 9214 | False | - | - | - | - |
...
| Vlan3009 | Tenant_A_OP_Zone | MLAG-IPv4-UNDERLAY-PEER | 65202 | - |
...
router bgp 65202
   ...
   vrf Tenant_A_OP_Zone
      ...
      router-id 192.2.255.5
      neighbor interface Vlan3009 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65202
