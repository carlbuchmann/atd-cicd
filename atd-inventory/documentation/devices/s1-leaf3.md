...
| --------- | --------------- | ------------ | --------- |
| ATD_LEAF2-DC1 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet4 | routed | - | - | default | 9214 | False | - | - | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet4 | routed | - | - | default | 9214 | False | - | - | - | - |
...
| Vlan4093 | default | MLAG-IPv4-UNDERLAY-PEER | 65102 | - |
| Vlan3009 | Tenant_A_OP_Zone | MLAG-IPv4-UNDERLAY-PEER | 65102 | - |
...
router bgp 65102
   ...
   vrf Tenant_A_OP_Zone
      ...
      router-id 192.0.255.5
      neighbor interface Vlan3009 peer-group MLAG-IPv4-UNDERLAY-PEER remote-as 65102
